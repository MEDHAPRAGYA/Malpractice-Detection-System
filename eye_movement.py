...
predictor = dlib.shape_predictor("C:/Users/ARPIT/OneDrive/Desktop/Cheating-Surveillance-System-main/model/shape_predictor_68_face_landmarks.dat")
...
def process_eye_movement(frame):
    ...
    for face in faces:
        ...
        left_eye_points = np.array([(landmarks.part(n).x, landmarks.part(n).y) for n in range(37, 42)])
        right_eye_points = np.array([(landmarks.part(n).x, landmarks.part(n).y) for n in range(43, 48)])
